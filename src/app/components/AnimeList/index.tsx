...
const AnimeList = ({ title, images, id }: Anime) => {
  return (
    ...
    <Link href={`/detail/${id}`}>
      <Image src={images} alt="image" width={350} height={350} className="rounded-3xl w-full transition-transform group-hover:scale-110 duration-200 md:max-h-[440px] sm:max-h-[250px] max-h-[220px]"/>
